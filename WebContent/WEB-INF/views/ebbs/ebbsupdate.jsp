...
<form name="frmForm" id="_frmForm" action="EbbsupdateAf.do" 
...
<tr>
	...
	<td style="text-align: left;">
		<input type="text" name="title" size="50" value="${Ebbs.id }">
	</td>
</tr>
...
<tr>
	...
	<td style="text-align: left;">
		<!-- 기존의 파일 -->
		<input type="text" name="namefile" value="${Ebbs.filename }" size="50" readonly="readonly">
		<!-- 수정할 파일 -->
